...
#             run = False
#     tela.fill('blue')
#     pygame.draw.rect(tela, 'white',(100,100,50,50))
#     pygame.draw.circle(tela, 'yellow',(250,250), 100)
...
# # 1 - JOGO DO TREX ( Modelo Google ) SEM SOM   
import pygame
import sys
import random
pygame.init()
...
trex2     = pygame.image.load('trex4.png')
cacto_img = pygame.image.load('obstacle1.png')
# cacto1  = pygame.image.load('obstacle1.png')
...
# ------------------------------------------------------------
    ...
    texto = fonte.render('PONTOS: ', str(score), True)
...
# # 1.1 - JOGO DO TREX ( Modelo Google ) COM SOM 
